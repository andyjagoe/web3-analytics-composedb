...
const deployWeb3AnalyticsComposite = async () => {
  const composite = await readEncodedComposite(ceramic, 'src/__generated__/event.json')
  await composite.startIndexingOn(ceramic)  
}

export { deployWeb3AnalyticsComposite }